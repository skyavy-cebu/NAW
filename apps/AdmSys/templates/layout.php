	...
	<body>
		<div class="header">
			<div class="header_wrapper">
				<a href="<?php echo url_for('/AdmSys.php/event'); ?>" alt=""><img src="/images/nwaw_logo_header.png" class="top_logo ie_anchor_no_border" /></a>
          ...
          <a href="<?php echo url_for('/AdmSys.php/newsletter'); ?>">Newsletter</a>
          <a href="<?php echo url_for('/AdmSys.php/account'); ?>" class="end">My Account</a>
				</div>
			</div>
    </div><!-- header -->
		<!-- header -->
