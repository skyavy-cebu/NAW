<?php
class AdminUserProfileForm extends BaseProfileForm{

  public function configure(){
    unset( 
			$this['created_at'], $this['updated_at'], $this['olio_url'],
    ...
    $this->setWidgets(array(
      ...
      'my_industry1' 			=> new sfWidgetFormSelect(array('choices' => $industry,'default'=>$my_industry[0])),
      'my_industry2' 			=> new sfWidgetFormSelect(array('choices' => $industry,'default'=>$my_industry[1])),
			'address' 				  => new sfWidgetFormInputText(), 
			'ido' 				 			=> new sfWidgetFormTextarea(),
      'industries_meet1'  => new sfWidgetFormSelect(array('choices' => $industry,'default'=>$industries_meet[0])),
      'industries_meet2'  => new sfWidgetFormSelect(array('choices' => $industry,'default'=>$industries_meet[1])),
      'industries_meet3'  => new sfWidgetFormSelect(array('choices' => $industry,'default'=>$industries_meet[2])),
      'industries_meet4'  => new sfWidgetFormSelect(array('choices' => $industry,'default'=>$industries_meet[3])),
      'industries_meet5'  => new sfWidgetFormSelect(array('choices' => $industry,'default'=>$industries_meet[4])),
